...
function pegarTodasInstituicoes(){
      ...
      .then(data => {
        ...
        for (let cont = 0; cont < dados.length; cont++) {
          ...
          imgElement.setAttribute("src", url + "/api/imagem/" + dados[cont].imagem);
          imgElement.setAttribute("alt", "Imagem 1");
          ...
          h5Element.textContent = dados[cont].nome;
      
          let pElement = document.createElement("p");
          pElement.classList.add("card-text");
          pElement.textContent = dados[cont].Descricao;

          let pElementProvincia = document.createElement("p");
          pElementProvincia.classList.add("card-text");
          pElementProvincia.innerHTML ="<b>Provincia: </b>"+ dados[cont].distrito.municipio.provincia.nome;

          let pElementMonicipio = document.createElement("p");
          pElementMonicipio.classList.add("card-text");
          pElementMonicipio.innerHTML ="<b>Monicipio: </b>"+ dados[cont].distrito.municipio.nome;

          let pElementDistrito = document.createElement("p");
          pElementDistrito.classList.add("card-text");
          pElementDistrito.innerHTML = "<b>Distrito: </b>"+dados[cont].distrito.nome;

      
          let aElement = document.createElement("a");
          aElement.classList.add("mt-auto", "btn", "btn-primary"); // Adiciona a classe mt-auto para empurrar o botão para a parte inferior
          aElement.textContent = "Saiba mais";
          aElement.setAttribute("name", dados[cont].id);
          aElement.style.backgroundColor = "#2c3e50"; 
          aElement.addEventListener("click", function () {
              perfilIntituicao(this);
          });
      
          cardBodyDiv.appendChild(h5Element);
          cardBodyDiv.appendChild(pElement);
          cardBodyDiv.appendChild(pElementProvincia);
          cardBodyDiv.appendChild(pElementMonicipio);
          cardBodyDiv.appendChild(pElementDistrito);
      
          cardDiv.appendChild(imgElement);
          cardDiv.appendChild(cardBodyDiv);
          cardDiv.appendChild(aElement); // Adiciona o botão após o corpo da carta
      
          colDiv.appendChild(cardDiv);
      
          divPai.appendChild(colDiv);
      }
